...
for name in classinfo['all']:
    # print(name['name'])
    if name['name'] == 'Joey':
        # print(f'My name is {name["name"]} and my spirit animal is {name["spirit animal"]}.')
        # print(f'My name is {name["name"]} and my skills are {name["skill level"]}.')
        # print(f'My name is {name["name"]} and my super power is {name["super power"]}.')

        print(f"""My name is {name["name"]} and my spirit animal is {name["spirit animal"]}. My name is {name["name"]} and my skills are {name["skill level"]}. My name is {name["name"]} and my super power is {name["super power"]}..""")
    
    print(f""" {name["name"]}, a {name["skill level"]} {name["spirit animal"]} of a programmer, possesses a {name["super power"]} factor for moonlighting as a superhero!""")